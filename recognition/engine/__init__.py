...
from recognition.liveness.minifasnet import LivenessResult, LivenessState, MiniFASNetLiveness
from recognition.matching.engine import RecognitionResult, RecognitionState, RecognitionEngine
from recognition.tracking.iou_tracker import IoUTracker, Track
from vision.alignment.arcface import ArcFaceAligner
from vision.detection import Detection
from vision.quality.assessor import FaceQualityAssessor, QualityResult
...
class RecognitionPipeline:
    ...
    def __init__(self, detector, aligner: ArcFaceAligner,
