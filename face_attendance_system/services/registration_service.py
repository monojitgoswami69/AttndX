...
class RegistrationService:
    ...
    def register_student_from_frames(self, student_id, name, frames):
        ...
        for i, frame in enumerate(frames):
            ...
            preprocessed = self.preprocessor.preprocess_face(face_crop)
            if preprocessed is None:
                result["issues"].append(f"{frame_label}: Preprocessing failed.")
                continue
        ...
        # Store in database (never block registration for twins)
