...
from gen2.vision.quality.assessor import QualityResult
...
class TestEnrollment:
    ...
    def test_inconsistent_samples_rejected(self, tmp_db, mock_components):
        ...
        from gen2.recognition.embeddings.arcface_onnx import EmbeddingResult
        call_count = [0]
        def mock_embed(face):
            call_count[0] += 1
    ...
    def test_index_updated_after_enrollment(self, tmp_db, mock_components):
        ...
        from gen2.recognition.matching.engine import RecognitionEngine, RecognitionState
